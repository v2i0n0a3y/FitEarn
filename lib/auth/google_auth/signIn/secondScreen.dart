...
class GoogleSecondScreen extends StatefulWidget {
  const GoogleSecondScreen({super.key});

  @override
  State<GoogleSecondScreen> createState() => _GoogleSecondScreenState();
}

class _GoogleSecondScreenState extends State<GoogleSecondScreen> {
  @override
                      ...
                      SizedBox(
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>GoogleThirdScreen()));
                            },
