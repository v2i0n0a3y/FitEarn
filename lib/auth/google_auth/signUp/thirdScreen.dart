...
class GoogleSignUpThirdScreen extends StatefulWidget {
  const GoogleSignUpThirdScreen({super.key});

  @override
  State<GoogleSignUpThirdScreen> createState() => _GoogleSignUpThirdScreenState();
}

class _GoogleSignUpThirdScreenState extends State<GoogleSignUpThirdScreen> {
