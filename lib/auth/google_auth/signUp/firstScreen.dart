...
import 'package:fitearnn/auth/google_auth/signUp/secondScreen.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class GoogleSignUpFirstScreen extends StatefulWidget {
  const GoogleSignUpFirstScreen({super.key});

  @override
  State<GoogleSignUpFirstScreen> createState() => _GoogleSignUpFirstScreenState();
}

class _GoogleSignUpFirstScreenState extends State<GoogleSignUpFirstScreen> {
  @override
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>GoogleSignUpSecondScreen()));
                      },
                      child: Row(
                        children: [
                          CircleAvatar(
